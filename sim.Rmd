...
log likelihood -- how to look at in simulation
systime
...
mydata <- UDF_sample(mobility = c(.2), J = c(100),rho = c(FALSE), tau = c("same"))
...
listdata <- getdata_ccrem_mmrem(mydata)
